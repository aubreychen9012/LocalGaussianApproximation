...
class VariationalAutoencoder():
    ...
    def encoder(self, x, reuse=False, is_train=True):
        ...
        with tf.variable_scope(self.model_name+"_encoder", reuse=reuse):
            ...
            #res4_stddev = resblock_down(res3, gf_dim * 4, gf_dim * 8, "res4_stddev", reuse, is_train, act=False)
            #self._activation_value_res4=res4
            # s16*s16
            res5 = resblock_down(res4, gf_dim * 8, gf_dim * 16, "res5", reuse, is_train, act=False)
            res5_stddev = resblock_down(res4, gf_dim * 8, gf_dim * 16, "res5_stddev", reuse, is_train, act=False)
    ...
    def decoder(self, x, name, reuse=False, is_train=True):
        ...
        with tf.variable_scope(self.model_name+"_decoder_"+name, reuse=reuse):
            ...
            # s32*s32
            res0 = resblock_up(x, gf_dim*16, gf_dim * 8, "gres0", reuse, is_train)
